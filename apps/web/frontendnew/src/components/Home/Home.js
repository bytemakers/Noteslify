  ...
  return (
    ...
    <div className="bg-white py-24 sm:py-32 lg:py-40">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Why choose Noteslify?</p>
    ...
    <div className="flex flex-col items-center gap-2">
        <div className="sm:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Customer Reviews</p>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600 mb-5">
