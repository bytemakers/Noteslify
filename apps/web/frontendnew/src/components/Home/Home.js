  ...
  return (
    <div>
      ...
      <div
        ...
        className={`isolate ${
          dark ? "bg-[#030414] text-white" : "bg-white"
        } transition-all`}
      >
        ...
        <div className="px-6 pt-6 lg:px-8">
          <div>
            ...
            >
              <div
                className="flex w-[9em] justify-between lg:min-w-0 "
                aria-label="Global"
              >
                ...
                <button className=" transition-all" onClick={handleToggleTheme}>
                  {dark ? (
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={`font-semibold ${
                      dark && "text-white hover:text-[#a1ace9]"
                    } text-gray-900 hover:text-gray-900 transition-all`}
                  >
                    {item.name}
                  </a>
                ))}
              ...
              <div className="hidden lg:flex lg:min-w-0  lg:justify-end">
                <a
                  ...
                  className={`inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ${
                    dark && "text-white ring-gray-600 hover:ring-gray-300/20"
                  } ring-1 ring-gray-900/10 hover:ring-gray-900/20 transition-all`}
                >
                  Sign Up
                </a>
              </div>
                    ...
                    <div className="py-6">
                      <a
                        ...
                        className={`-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 ${
                          dark && "text-white"
                        } text-gray-900 hover:bg-gray-400/10`}
                      >
                        Log in
                      </a>
                    </div>
                  ...
                  <div className="mt-8 flex gap-x-4 sm:justify-center">
                    ...
                    <a
                      ...
                      className={`inline-block rounded-lg px-4 py-1.5 text-base font-semibold leading-7 text-gray-900 ring-1 ring-gray-900/10 hover:ring-gray-900/20 ${
                        dark &&
                        "text-gray-200 ring-1 ring-gray-300/10 hover:ring-gray-900/20"
                      } transition-all`}
                    >
                      Visit Github
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="sm:text-center">
            ...
            <p
              className={`${
                dark && "text-gray-400"
              } mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600`}
            >
      ...
      {/* ### TESTIMONIALS START */}
      <div
        className={`${dark && "bg-[#030414]"} flex flex-col items-center gap-2`}
      >
        <div className="sm:text-center">
          <h2 className="text-lg font-semibold leading-8 text-blue-600">
            Testimonials
          ...
          <p
            className={`${
              dark && "text-gray-400"
            } mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600 mb-5`}
          >
