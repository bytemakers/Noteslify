    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          ...
          <a href="/pricing" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100">
                View Pricing
            </a>
        </div>
